...
//preprocessing the sequence to get it homogeneous
...
//INFO: reads in halterung parser
        auto fileParserThreadFunction = [&](
            ...
            nvtx::push_range("fileparserThread batch", 0);
        ...
        auto pairedfileParserThreadFunction = [&](
            ...
            std::size_t totalNumberOfReads = 0;
            nvtx::push_range("pairedfileparserThread", 1);
        ...
        auto encoderThreadFunction = [&](){
            ...
            while(sbatch != nullptr){
                nvtx::push_range("encoderThreadFunction batch", 2);
                int maxLength = 0;
                int Ncount = 0;
        ...
        auto inserterThreadFunction = [&](){
            ...
            while(sbatch != nullptr){
                nvtx::push_range("inserterThreadFunction batch", 3);
